...
w2 = model.w2 = Var(I,J, domain = Binary, doc = '1 if rectangle j is placed to the rigth of rectangle i. 0 otherwise')
...
# GAMS solver call
#SolverFactory('gams').solve(model, solver = 'cplex', tee = True, keepfiles=True)
